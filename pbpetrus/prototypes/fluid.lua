...
{
  {
    ...
    base_color = { 1, 1, 1},
    flow_color = { 1, 1, 1},
    icon = "__pbpetrus__/graphics/icons/fluid/ethanol.png",
  ...
  },
  {
    ...
    icon = "__pbpetrus__/graphics/icons/fluid/uranium-235-hexafluoride.png",
    order = "b[new-fluid]-f[gleba]-a[ethanol]"
  },
  {
    type = "fluid",
    ...
    icon = "__pbpetrus__/graphics/icons/fluid/uranium-238-hexafluoride.png",
    order = "b[new-fluid]-f[gleba]-a[ethanol]"
  },
  --{
  --  type = "fluid",
