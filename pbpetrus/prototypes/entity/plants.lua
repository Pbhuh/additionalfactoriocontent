...
data:extend(
{
  ...
  },
  {
    ...
    drawing_box_vertical_extension = 0.8,
    subgroup = "trees",
    order = "a[tree]-c[gleba]-a[seedable]-a[boompuff-tree]",
    impact_category = "tree",
    ...
    autoplace =
    {
      ...
      probability_expression = "min(0.2, 0.3 * (1 - gleba_plants_noise) * control:gleba_plants:size)",
      richness_expression = "random_penalty_at(3, 1)",
      tile_restriction = {"natural-boompuff-soil", "artificial-boompuff-soil", "overgrowth-boompuff-soil" } --todo
    },
    variations = gleba_tree_variations("boompuff", 8, 4, 1.3),
    colors = minor_tints(),
    agricultural_tower_tint =
    {
      primary = {r = 0.552, g = 0.218, b = 0.218, a = 1.000}, -- #8c3737ff
  ...
  },
  {
    ...
    autoplace =
    {
      ...
      richness_expression = "random_penalty_at(3, 1)",
	  tile_restriction = { "titanium-platform-foundation" } --disable spawning?
    },
