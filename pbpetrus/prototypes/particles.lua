...
particle_animations.get_old_lead_ore_particle_pictures = function(options)
  return
  {
    {
      filename = "__pbpetrus__/graphics/particle/lead-ore-particle/lead-ore-particle-1.png",
      priority = "extra-high",
      width = 32,
      height = 32,
      scale = 0.5
    ...
    {
      filename = "__pbpetrus__/graphics/particle/lead-ore-particle/lead-ore-particle-2.png",
      priority = "extra-high",
      width = 32,
      height = 32,
      scale = 0.5
    ...
    {
      filename = "__pbpetrus__/graphics/particle/lead-ore-particle/lead-ore-particle-3.png",
      priority = "extra-high",
      width = 32,
      height = 32,
      scale = 0.5
    ...
    {
      filename = "__pbpetrus__/graphics/particle/lead-ore-particle/lead-ore-particle-4.png",
      priority = "extra-high",
      width = 32,
      height = 32,
      scale = 0.5
...
local particles =
{
  make_particle
  {
    ...
    life_time = 180,
    pictures = particle_animations.get_old_lead_ore_particle_pictures(),
