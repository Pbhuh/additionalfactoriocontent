...
data:extend
{
    ...
    subgroup = "artificial-tiles",
    minable = {mining_time = 0.5, result = "titanium-platform-foundation"},
    mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg", volume = 0.8}, -- sound?
    is_foundation = true,
    allows_being_covered = false,
    max_health = 50,
    ...
    variants =
    {
      ...
      {
        {
          picture = "__pbpetrus__/graphics/terrain/space-platform/titanium-platform-1x1.png",
          count = 16,
          size = 1,
          scale = 0.5
        },
        {
          picture = "__pbpetrus__/graphics/terrain/space-platform/titanium-platform-2x2.png",
          count = 16,
          size = 2,
          probability = 0.75,
          scale = 0.5
