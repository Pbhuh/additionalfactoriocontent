...
data:extend({
  ...
  },
  {
    ...
    order = "d[boompuff]-d[artificial-boompuff-soil]",
    subgroup = "gleba-tiles",
    minable = {mining_time = 0.5, result = "artificial-boompuff-soil"},
    mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg", volume = 0.8}, -- sound?
    is_foundation = true,
    collision_mask = tile_collision_masks.ground(),
    layer = gleba_tile_offset + 22,
    ...
    sprite_usage_surface = "gleba",
    variants = tile_variations_template_with_transitions(
      "__pbpetrus__/graphics/terrain/artificial-boompuff-soil.png",
      {
        max_size = 4,
        [1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
        [2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
  ...
  },
  {
    ...
    order = "d[boompuff]-e[overgrowth-boompuff-soil]",
    subgroup = "gleba-tiles",
    minable = {mining_time = 0.5, result = "overgrowth-boompuff-soil"},
    mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg", volume = 0.8}, -- sound?
    is_foundation = true,
    collision_mask = tile_collision_masks.ground(),
    layer = gleba_tile_offset + 24,
    ...
    sprite_usage_surface = "gleba",
    variants = tile_variations_template_with_transitions(
      "__pbpetrus__/graphics/terrain/overgrowth-boompuff-soil.png",
      {
        max_size = 4,
        [1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
        [2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
  ...
  },
  {
    ...
    sprite_usage_surface = "gleba",
    variants = tile_variations_template_with_transitions(
      "__pbpetrus__/graphics/terrain/natural-boompuff-soil.png",
      {
        max_size = 4,
        [1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
        [2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
